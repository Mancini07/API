...
CREATE TABLE "deliveries_log" (
    ...
    CONSTRAINT "deliveries_log_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "deliveries_log" ADD CONSTRAINT "deliveries_log_delivery_id_fkey" FOREIGN KEY ("delivery_id") REFERENCES "deliveries"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
